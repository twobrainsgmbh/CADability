        ...
        , IPropertyEntry
    {
        ...
        public class BooleanInput : InputObject, IInputObject
        {
            ...
            public void ForceValue(bool val)
            {
                ...
                //BooleanInput does not support bool SetBooleanEvent(bool) pattern
                if (ReadOnly) return;
                Value = val;
                constructAction.RefreshDependantProperties();
        ...
        /// <summary>
        /// Delegate definiation for the <see cref=" cref="InputIndexChangedEvent"/>.
        /// </summary>
        public delegate void InputIndexChangedDelegate(int currentInputIndex, int oldInputIndex);
        /// <summary>
        /// Occurs when the Input Index Changed
        /// </summary>
        public event InputIndexChangedDelegate InputIndexChangedEvent;
        ...
        private void SetCurrentInputIndex(int Index, bool ActivateMouse)
        {
            ...
            int oldInputIndex = currentInputIndex;
            currentInputIndex = Index;
            OnInputIndexChanged(currentInputIndex, oldInputIndex);
        ...
        /// <summary>
        /// Set index of the active input
        /// </summary>
        /// <param name="index"></param>
        public void SetCurrentInputIndex(int index) => SetCurrentInputIndex(index, false);        

        private void OnInputIndexChanged(int currentInputIndex, int oldInputIndex)
        {
            if (InputIndexChangedEvent != null)
                InputIndexChangedEvent(currentInputIndex, oldInputIndex);
        }
